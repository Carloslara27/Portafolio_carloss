  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background text-foreground relative">
        ...
        <section id="home" className="pt-32 pb-24 relative z-10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              ...
              >
                <a
                  href="#contact"
                  className="px-8 py-4 bg-foreground text-background rounded-lg font-medium transition-all duration-300 hover:opacity-90 hover:shadow-lg"
                >
                  Contactame
                </a>
                <a
                  href="#projects"
                  className="px-8 py-4 bg-transparent border-2 border-border hover:border-foreground/30 rounded-lg font-medium transition-all duration-300"
                >
                  Ver Proyectos
                </a>
              </motion.div>
